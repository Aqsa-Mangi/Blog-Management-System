<?php 
	...
	function getUserRole($user_role_id){
		global $connection;
		$query = "SELECT `roles`.`role_id`, `users`.`user_id` FROM `users`
			...
			<form action="<?php echo $action; ?>" method="<?php echo $method; ?>">
				<table>
						...
						<tr>
							<th>Post Summary</th>
							<td>
								<textarea cols="50" rows="3" name="post_summary" required></textarea>
							</td>
						</tr>
						<tr>
			...
			<form action="<?php echo $action; ?>" method="<?php echo $method; ?>">
				...
				<table>
						...
						<tr>
							<th>Post Summary</th>
							<td>
								<textarea cols="50" rows="3" name="post_summary" required><?php echo $data['post_summary']; ?></textarea>
							</td>
						</tr>
						<tr>
							<th>Post Description</th>
